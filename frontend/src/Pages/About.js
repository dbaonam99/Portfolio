            ...
            <div className="about-container">
                ...
                <div className="about-introduce flex">
                    <div className="about-avt flex-center">
                        <img src="https://scontent.fsgn2-3.fna.fbcdn.net/v/t1.15752-9/138472045_871082040127340_7595270232215518102_n.jpg?_nc_cat=106&ccb=2&_nc_sid=ae9488&_nc_ohc=DBtueculOlMAX_7o2aB&_nc_ht=scontent.fsgn2-3.fna&oh=8326102d792c5c574946a692d4fa8c5e&oe=60267FC4" alt=""></img>
                    </div>
                    <div className="about-introduce-text flex-col">
                        <div className="about-introduce-title">
                            Hello! My name is <strong>Duong Bao Nam</strong>. I am a third year student at the University of Information Technology (UIT). I have the desire to become a back-end & front‑end developer, I am passionate about building excellent website that improves the lives of those around me.
                        </div> 
                        <div className="flex" style={{flexWrap: 'wrap'}}>
                            <div className="about-introduce-item flex">
                                <div className="about-introduce-left">
                                    Age: 
                                </div>
                        ...
                        <div className="education-item flex">
                            ...
                            <div className="education-item-right flex-col"> 
                                ...
                                <div className="education-text">
                                    ...
                                    <div className="education-text-small">Learn Information Technology, major in Information System</div>
                                </div>
                            </div>
                        </div>
                    </div>
